import { HeaderWrapper, MainLogo, Search, SearchInput } from "./styles";
...
const Header = () => {
  ...
  const onAvengerForm = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (!value && !value.trim()) {
      return;
    }
  ...
  return (
    <HeaderWrapper>
      <Link to="/">
        <MainLogo width="130" height="52" xmlns="http://www.w3.org/2000/svg">
